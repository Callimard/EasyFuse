...
@Slf4j
@Singleton
public class NIOFileReferenceFactory implements FileReferenceFactory {
    ...
    @Inject
    public NIOFileReferenceFactory(@NonNull FileReferenceGenerator fileReferenceGenerator) {
