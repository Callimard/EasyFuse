...
@Slf4j
@Singleton
public class NIOGlobalActionManager extends NIOFuseManager implements GlobalActionManager {
    ...
    @Inject
    public NIOGlobalActionManager(@NonNull PhysicalPathRecover pathRecover, @NonNull AttributeUtil attributeUtil) {
        super(pathRecover);
    ...
    public int access(String path, int mask) {
        ...
        try {
            ...
            Set<AccessMode> accessModes = attributeUtil.accessModeMaskToSet(mask);
    ...
    public int chmod(String path, long mode) {
        ...
        try {
            ...
            Files.setPosixFilePermissions(physicalPath, attributeUtil.octalModeToPosixPermissions(mode));
            return 0;
        } catch (IOException e) {
